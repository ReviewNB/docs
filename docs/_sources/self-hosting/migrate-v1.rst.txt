...
============================
This is a major version upgrade with some |new exciting features|. There's only one change required in setup/installation - we require connecting to SMTP server to send emails.
...
Following SMTP server credentials are required.
